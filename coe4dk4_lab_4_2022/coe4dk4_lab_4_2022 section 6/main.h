...
typedef struct _simulation_run_data_
{
  ...
  Channel_Ptr reservation_channel;
  ...
  long int mean_backoff_duration;
  long int number_of_stations;
  double arrival_rate;
  long int runs_required;
  long int run_count;
  int EXP_OR_FIXED_BACKOFF;
  double successful_transmit_time;
  int attempted_transmissions;
  double mean_data_duration;
