...
typedef struct _simulation_run_data_
{
  ...
  long int trunk_count;
  double arrival_rate;
  double mean_hangup_time;
  long int hangup_count;
  long int non_hangup_count;
  double queuing_time_accum;
  double queuing_time_accum_no_hangup;
  long int queued_call_count;
  long int non_queued_call_count;
  long int wait_less_t;
  double t_val;
  double mean_call_time;
